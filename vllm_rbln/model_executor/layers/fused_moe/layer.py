...
def _get_tokens_mask():
    num_tokens = get_forward_context().dp_metadata.num_tokens_across_dp_cpu
...
def fused_moe_naive_multicast_rbln(
    self, x: torch.Tensor, cu_tokens_across_dp_cpu: torch.Tensor
):
