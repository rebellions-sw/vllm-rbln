...
from vllm.model_executor.models import (deepseek_v2, gemma3, llama, llama4,
                                        qwen2, qwen2_moe, qwen3_moe, utils)
...
gemma3.Gemma3Model.load_weights = load_gemma3_weights
